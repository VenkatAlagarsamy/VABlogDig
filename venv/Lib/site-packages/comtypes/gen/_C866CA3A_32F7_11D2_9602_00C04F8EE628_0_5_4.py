...
__all__ = [
    'SVP_7', 'ISpDataKey', 'DISPID_SpeechMMSysAudio',
    'SPEI_RESERVED5', 'DISPID_SVEVoiceChange', 'SGSEnabled',
    'DISPID_SOTGetStorageFileName', 'SpeechCategoryRecoProfiles',
    'SITooFast', 'eLEXTYPE_RESERVED4', 'SAFTADPCM_44kHzMono',
    'DISPID_SPISaveToMemory', 'SSTTDictation', 'SPSUnknown',
    'SAFT16kHz8BitMono', 'SPWORD', 'DISPID_SPIAudioSizeBytes',
    'SVEEndInputStream', 'SAFTADPCM_22kHzMono', 'ISpeechObjectToken',
    'SAFT32kHz16BitStereo', 'IInternetSecurityMgrSite',
    'SPSHT_NotOverriden', 'SREPhraseStart', 'DISPID_SRGRules',
    'DISPID_SFSOpen', 'eLEXTYPE_RESERVED6', 'SpeechPartOfSpeech',
    'DISPID_SpeechPhraseRule', 'SVF_Stressed', 'SVSFParseSsml',
    'ISpeechPhraseReplacements', 'SPSModifier', 'SpeechVisemeType',
    'DISPID_SBSWrite', 'DISPID_SAFSetWaveFormatEx',
    'DISPID_SpeechWaveFormatEx', 'SPXRO_Alternates_SML',
    'eLEXTYPE_PRIVATE5', 'DISPID_SOTCategory', 'SPPS_Interjection',
    'DISPID_SRSCurrentStreamPosition', 'SRAInterpreter',
    'ISpPhraseAlt', 'SPINTERFERENCE_NONE', 'SVP_3', 'SPBO_NONE',
    'SLTUser', 'DISPID_SOTs_NewEnum', 'DISPID_SGRSTs_NewEnum',
    'SDTDisplayText', 'SPPS_RESERVED3', 'DISPID_SRRPhraseInfo',
    'DISPID_SGRsAdd', 'DISPIDSPRG', 'ISpRecognizer2', 'SP_VISEME_14',
    'DISPID_SPCIdToPhone', 'tagSPPROPERTYINFO', 'SPAS_STOP',
    'DISPID_SASetState', 'DISPID_SLWLangId', 'SpeechRecognitionType',
    'DISPID_SAFType', 'DISPID_SRRGetXMLResult', 'SVP_21',
    'SP_VISEME_6', 'ISpProperties', 'SPAS_PAUSE',
    'STSF_CommonAppData', '_SPAUDIOSTATE', 'SpPhraseInfoBuilder',
    'SRTAutopause', '__MIDL___MIDL_itf_sapi_0000_0020_0002',
    'DISPID_SABufferNotifySize', 'SREAdaptation', 'SSFMOpenForRead',
    'DISPID_SpeechPhraseElement', 'DISPID_SDKDeleteKey',
    'DISPID_SPPEngineConfidence', 'SSFMOpenReadWrite',
    'DISPID_SRRTLength', 'DISPID_SpeechGrammarRuleState',
    'DISPID_SASNonBlockingIO', 'DISPID_SpeechXMLRecoResult',
    'SAFTDefault', 'DISPID_SGRsDynamic', 'ISpeechMemoryStream',
    'DISPID_SPELexicalForm', 'SPPHRASERULE', 'DISPID_SDKEnumValues',
    'SP_VISEME_17', 'eLEXTYPE_RESERVED9', 'SVSFNLPSpeakPunc',
    'SpeechPropertyHighConfidenceThreshold', 'DISPID_SPEsCount',
    'SPINTERFERENCE_TOOLOUD', 'DISPID_SGRInitialState',
    'Speech_StreamPos_RealTime', 'DISPID_SGRSAddSpecialTransition',
    'ISpRecoCategory', 'SVP_6', 'SPGRAMMARSTATE',
    'SAFT11kHz16BitMono', 'SAFTCCITT_uLaw_22kHzMono',
    'DISPID_SRRTStreamTime', 'DISPID_SPILanguageId',
    'DISPID_SPIEngineId', 'SDA_Consume_Leading_Spaces',
    'SAFT32kHz8BitMono', 'DISPID_SAFGetWaveFormatEx',
    'SAFT8kHz8BitMono', 'DISPID_SpeechRecoContextEvents',
    'SPPHRASEELEMENT', 'eLEXTYPE_PRIVATE12', 'ISpeechAudio',
    'SpeechGrammarTagDictation', 'DISPID_SLPs_NewEnum',
    'SAFT24kHz16BitMono', 'DISPID_SPPId', 'SGLexicalNoSpecialChars',
    'SpeechPropertyNormalConfidenceThreshold', 'SPWORDTYPE', 'SDTAll',
    'SPWF_INPUT', 'SpeechWordPronounceable', 'SpeechEngineProperties',
    'DISPID_SDKEnumKeys', 'DISPID_SGRSTText', 'eLEXTYPE_PRIVATE8',
    'DISPID_SGRs_NewEnum', 'SAFT48kHz8BitMono', 'ISpeechAudioFormat',
    'DISPID_SRGReset', 'SDA_No_Trailing_Space', 'DISPID_SAFGuid',
    'DISPID_SABIMinNotification', 'SpMMAudioOut',
    'DISPID_SpeechPhoneConverter', 'eLEXTYPE_PRIVATE3',
    'ISpStreamFormat', 'DISPID_SVSInputWordPosition', 'SVP_16',
    'eLEXTYPE_PRIVATE10', 'DISPID_SpeechAudio', 'eLEXTYPE_PRIVATE14',
    'SPSHORTCUTPAIR', 'DISPID_SPAPhraseInfo', 'SPFM_CREATE',
    'ISpeechGrammarRuleStateTransition', 'SAFT48kHz16BitMono',
    'ISpObjectWithToken', 'SVP_11', 'SpFileStream', 'SP_VISEME_5',
    'SAFT22kHz8BitMono', 'SRSEDone', 'DISPID_SRRTOffsetFromStart',
    'SASPause', 'DISPID_SREmulateRecognition', 'ISpRecoContext',
    'SAFT12kHz16BitMono', 'DISPID_SRSetPropertyString',
    'SAFTCCITT_ALaw_44kHzMono', 'DISPID_SpeechPhraseAlternate',
    'SSTTTextBuffer', 'DISPID_SGRsCount', 'DISPID_SAEventHandle',
    'SAFTCCITT_ALaw_8kHzStereo', 'DISPID_SMSGetData',
    'eLEXTYPE_PRIVATE13', 'SPEI_PHRASE_START', 'SDTPronunciation',
    'SPCT_SUB_DICTATION', 'SpeechLoadOption', 'SVP_17',
    'SPAR_Unknown', 'SRTExtendableParse', 'SPEI_RESERVED6',
    ...
    'DISPID_SPAStartElementInResult', 'SGDSInactive', 'SPVOICESTATUS',
    'DISPID_SVResume', 'SAFT24kHz16BitStereo', 'SPEI_TTS_BOOKMARK',
    ...
    'DISPID_SRCEStartStream', 'DISPID_SPPsCount', 'SPEI_RECOGNITION',
    'Speech_Max_Pron_Length', 'SAFTADPCM_8kHzMono',
    'ISpPhoneConverter', 'SPSVerb', 'DISPID_SVGetProfiles',
    'SAFT11kHz16BitStereo', 'SpeechRuleAttributes',
    'SpeechBookmarkOptions', 'SpeechTokenShellFolder', 'SVEAllEvents',
    'SVP_13', 'DISPID_SABufferInfo', 'SPEVENTENUM',
    'SpeechAudioFormatType', 'DISPID_SLWPronunciations',
    'eLEXTYPE_PRIVATE9', 'SRAImport', 'DISPID_SLWWord',
    'DISPID_SDKGetBinaryValue', 'DISPID_SPEsItem', 'DISPID_SLWType',
    'SPPHRASE', 'SPVPRI_OVER', 'SpeechTokenIdUserLexicon',
    'SpAudioFormat', 'DISPIDSPTSI_ActiveLength',
    'SPEI_SR_AUDIO_LEVEL', 'DISPID_SRRTTickCount',
    'DISPID_SRCEAdaptation', 'SVSFIsXML', 'SBOPause', 'SRADynamic',
    'SpeechUserTraining', 'DISPID_SPAsCount',
    'DISPID_SLRemovePronunciationByPhoneIds', 'SAFTNoAssignedFormat',
    'STCInprocHandler', 'SDTReplacement', 'SPFM_OPEN_READONLY',
    'SINone', 'DISPID_SGRSTsItem', 'DISPID_SASFreeBufferSpace',
    'DISPID_SPIGetText', 'DISPID_SpeechCustomStream',
    'SAFT22kHz16BitStereo', 'SAFTCCITT_ALaw_22kHzStereo',
    'DISPID_SPRuleParent', 'STSF_FlagCreate', 'DISPID_SLPType',
    'WAVEFORMATEX', 'DISPID_SRGCmdSetRuleIdState', 'SVP_0',
    'SP_VISEME_19', 'SECFIgnoreWidth', 'SpeechEngineConfidence',
    'SPEI_RESERVED1', 'DISPID_SVPause', 'SPEVENTSOURCEINFO', 'STCAll',
    'DISPID_SpeechRecoResultTimes', 'SpeechTokenValueCLSID',
    'ISpeechRecoContext', 'SVESentenceBoundary', 'SDTLexicalForm',
    'DISPID_SpeechPhraseReplacements',
    'DISPID_SVAllowAudioOuputFormatChangesOnNextSet',
    'SAFT11kHz8BitStereo', 'DISPID_SPRuleName', 'ISpNotifySource',
    'DISPID_SPIRule', 'DISPID_SVEWord', 'SVSFParseMask',
    'eLEXTYPE_LETTERTOSOUND', 'DISPID_SPRuleEngineConfidence',
    'SVF_None', 'SpPhoneConverter', 'SPINTERFERENCE_NOSIGNAL',
    'SECFIgnoreKanaType', 'Speech_Default_Weight', 'SVP_18',
    'SpeechVoiceSkipTypeSentence', 'DISPID_SpeechBaseStream',
    'SITooSlow', 'DISPID_SVIsUISupported',
    'SPSMF_SRGS_SEMANTICINTERPRETATION_W3C',
    'SPINTERFERENCE_LATENCY_WARNING', 'SpeechVoiceCategoryTTSRate',
    'SPLEXICONTYPE', 'SPCT_SUB_COMMAND', 'IStream', 'SPEI_SOUND_END',
    'DISPID_SVGetVoices', 'DISPID_SCSBaseStream', 'SPLO_DYNAMIC',
    'SPCONTEXTSTATE', 'SPSHORTCUTTYPE',
    'SSSPTRelativeToCurrentPosition',
    'SpeechPropertyLowConfidenceThreshold', 'DISPID_SVEStreamEnd',
    'SpeechRetainedAudioOptions', 'DISPID_SpeechPhraseReplacement',
    'eLEXTYPE_PRIVATE16', 'DISPID_SpeechRecoResult2',
    'DISPID_SRCRequestedUIType', 'DISPID_SRCEEnginePrivate',
    'ISpeechObjectTokenCategory', 'SREAudioLevel',
    'DISPID_SPEs_NewEnum', 'SPEI_SR_BOOKMARK', 'DISPID_SLPPhoneIds',
    'DISPID_SRRSetTextFeedback', 'SRTSMLTimeout', 'DISPID_SGRSRule',
    'SPLOADOPTIONS', 'ISpeechLexiconWords', 'SPEI_TTS_PRIVATE',
    'SpeechCategoryAudioOut', 'DISPID_SRGCmdLoadFromResource',
    'DISPID_SRCERecognitionForOtherContext', 'SPPS_Noncontent',
    'SGRSTTWildcard', 'SPEI_PROPERTY_STRING_CHANGE', 'SPPS_LMA',
    'DISPID_SpeechPhraseProperties', 'SPCT_COMMAND', 'DISPIDSPTSI',
    'DISPID_SGRSTType', 'DISPID_SABIEventBias',
    'ISpeechPhoneConverter', 'ISpObjectToken',
    'DISPID_SWFEBitsPerSample', 'SECFIgnoreCase',
    'DISPID_SVEBookmark', 'SECLowConfidence',
    'SPSMF_SRGS_SAPIPROPERTIES', 'DISPID_SpeechPhraseElements',
    'SPRST_ACTIVE', 'DISPID_SLGetWords', 'SAFT16kHz16BitStereo',
    'DISPID_SGRSTPropertyId', 'SVEPhoneme', 'SpeechDataKeyLocation',
    'SpeechGrammarWordType', 'SPEI_SR_RETAINEDAUDIO', 'tagSTATSTG',
    'DISPID_SPIElements', 'DISPID_SRCEPhraseStart',
    'SpeechVoiceSpeakFlags', 'eLEXTYPE_RESERVED10', 'SRTStandard',
    'SAFT24kHz8BitStereo', 'ISpResourceManager',
    'DISPID_SPRs_NewEnum', 'DISPID_SPEDisplayAttributes',
    'DISPID_SGRSTNextState', 'SpeechAudioVolume', 'SPEI_SOUND_START',
    'SRADefaultToActive', 'DISPID_SGRSAddRuleTransition',
    'ISpeechRecognizer', 'ISpeechRecognizerStatus', 'SP_VISEME_18',
    'ISpeechRecoResultTimes', 'SPFILEMODE', 'ISpeechPhraseInfo',
    'DISPID_SWFEExtraData', 'SpeechVisemeFeature', 'DISPID_SPCLangId',
    'SPBO_PAUSE', 'SAFTExtendedAudioFormat',
    ...
    'ISpObjectTokenCategory', 'SGDSActive', 'SVP_4', 'SPEI_PHONEME',
    'SpObjectTokenCategory', 'SWTDeleted', 'SPAS_CLOSED',
    'ISpStreamFormatConverter', 'DISPID_SVEPhoneme', 'SRSActive',
    'ISpRecoContext2', 'DISPID_SPRuleNumberOfElements',
    'DISPID_SOTCGetDataKey', 'DISPID_SOTCSetId', 'SPAS_RUN',
    'DISPID_SRGIsPronounceable', 'SpSharedRecoContext',
    'SPEI_RECO_OTHER_CONTEXT', 'SPBOOKMARKOPTIONS',
    'SpeechLexiconType', 'SpeechAddRemoveWord',
    'Speech_Max_Word_Length', 'DISPID_SPPChildren', 'DISPID_SGRId',
    'SVSFIsFilename', 'SAFT24kHz8BitMono', 'DISPID_SpeechPhraseRules',
    'SPGS_DISABLED', 'DISPID_SLPSymbolic', 'SPSFunction',
    'ISpeechPhraseRules', 'DISPID_SPRuleId', 'SpeechWordType',
    'SpeechVoiceEvents', 'SpUnCompressedLexicon',
    'SAFT32kHz16BitMono', 'DISPID_SpeechRecoResult',
    'DISPID_SVSLastBookmarkId', 'SPPS_Verb',
    'SAFTCCITT_uLaw_11kHzMono', 'SAFT11kHz8BitMono',
    '_ISpeechRecoContextEvents', 'ISpeechRecoGrammar',
    'ISpeechRecoResult2', 'ISpGrammarBuilder', 'SINoSignal',
    'DISPID_SRAllowAudioInputFormatChangesOnNextSet',
    'DISPID_SRGetRecognizers', 'SVEBookmark', 'eLEXTYPE_PRIVATE18',
    'eLEXTYPE_PRIVATE4', 'DISPID_SPIReplacements',
    'SAFTCCITT_ALaw_11kHzMono', 'SP_VISEME_15',
    'DISPID_SRCESoundStart', 'SAFT16kHz8BitStereo', 'SPSNoun',
    'ISpeechGrammarRuleStateTransitions', 'ISpeechWaveFormatEx',
    'ISpeechBaseStream', 'DISPID_SLWsItem', 'SVP_8', 'SGLexical',
    'DISPID_SPIStartTime', 'DISPID_SRCERecognition', 'SP_VISEME_2',
    'SSTTWildcard', 'SREStreamEnd', 'DISPID_SRRDiscardResultInfo',
    'SPRS_ACTIVE', 'DISPID_SDKCreateKey', 'DISPID_SPPName',
    'SpeechAudioFormatGUIDText', 'SPEI_INTERFERENCE',
    'DISPID_SVSLastResult', 'DISPID_SDKSetBinaryValue',
    'STSF_AppData', 'DISPID_SGRSAddWordTransition', 'DISPID_SAStatus',
    'DISPID_SpeechPhraseProperty', 'ISpeechMMSysAudio',
    'DISPID_SVEStreamStart', 'SPWP_KNOWN_WORD_PRONOUNCEABLE',
    'DISPID_SLWsCount', 'SPINTERFERENCE_TOOQUIET', 'SAFTText',
    'SpLexicon', 'IInternetSecurityManager', 'DISPID_SWFEFormatTag',
    'SpeechStreamSeekPositionType', 'SPAUDIOSTATUS', 'ISpeechVoice',
    'SP_VISEME_16', 'DISPID_SVEventInterests',
    'DISPID_SPERetainedStreamOffset', 'SREFalseRecognition',
    'SPGRAMMARWORDTYPE', 'SGRSTTTextBuffer', 'SVSFPurgeBeforeSpeak',
    'SVP_15', 'DISPID_SpeechPhraseAlternates',
    'DISPID_SRGCmdLoadFromFile', 'SP_VISEME_8',
    'DISPID_SLAddPronunciation', 'SPPHRASEREPLACEMENT',
    'SPCS_ENABLED', 'SWTAdded', 'ISpeechPhraseProperty',
    'DISPID_SPERetainedSizeBytes', 'SpeechCategoryVoices',
    'DISPID_SRCPause', 'eLEXTYPE_USER_SHORTCUT', 'DISPID_SLPsItem',
    'SPSInterjection', 'DISPID_SpeechAudioFormat',
    'SPFM_CREATE_ALWAYS', 'DISPID_SpeechObjectToken',
    'SAFT32kHz8BitStereo', 'DISPID_SPRulesItem',
    'ISpeechPhraseAlternates', 'SPEI_FALSE_RECOGNITION',
    'eLEXTYPE_USER', 'SDTAlternates', 'DISPID_SpeechAudioBufferInfo',
    'DISPID_SRCEFalseRecognition', 'DISPID_SRSNumberOfActiveRules',
    'eLEXTYPE_PRIVATE7', 'SAFTCCITT_uLaw_11kHzStereo',
    'SPEI_HYPOTHESIS', 'DISPID_SpeechDataKey', 'SPPROPERTYINFO',
    'SVEStartInputStream', 'DISPID_SLWs_NewEnum', 'DISPID_SAVolume',
    'SAFT8kHz8BitStereo', 'SP_VISEME_21', 'eLEXTYPE_PRIVATE19',
    'ISpeechAudioBufferInfo', 'DISPID_SPPFirstElement',
    'DISPID_SOTId', 'SVP_14', 'SAFT8kHz16BitStereo', 'SPCT_DICTATION',
    'DISPID_SVDisplayUI', 'SPBO_TIME_UNITS', 'SRAORetainAudio',
    'DISPID_SVGetAudioOutputs', 'SLTApp', 'SAFT48kHz16BitStereo',
    'SRARoot', 'SpMemoryStream', 'SPAR_High', 'SpeechAudioProperties',
    'DISPID_SOTGetAttribute', 'SPRECOCONTEXTSTATUS',
    'DISPID_SpeechPhraseBuilder', 'DISPID_SPEActualConfidence',
    'DISPID_SRAudioInputStream', 'SpInprocRecognizer',
    'SpeechGrammarTagWildcard', 'DISPID_SVWaitUntilDone',
    'SREAllEvents', 'STCInprocServer', 'DISPID_SPPsItem',
    'ISpeechResourceLoader', 'SpeechGrammarTagUnlimitedDictation',
    'DISPID_SWFEChannels', 'DISPID_SRGetPropertyNumber', 'SPXRO_SML',
    'DISPID_SRGetPropertyString', 'SDKLCurrentConfig',
    'SpTextSelectionInformation', 'SECHighConfidence', 'SPRULE',
    'DISPID_SVSpeak', 'DISPID_SGRSTRule', 'SPSTREAMFORMATTYPE',
    'SAFT16kHz16BitMono', 'SPPS_RESERVED4',
    'DISPID_SPERequiredConfidence', 'ISpRecoResult',
    'STCRemoteServer', 'SAFT12kHz16BitStereo', 'DISPID_SVVoice',
    'SpNullPhoneConverter', 'ISpeechLexiconPronunciations',
    'SPXMLRESULTOPTIONS', 'SPGS_EXCLUSIVE', 'SPVPRI_ALERT',
    'DISPID_SPIAudioStreamPosition', 'DISPID_SGRName',
    'SPEI_ACTIVE_CATEGORY_CHANGED', 'SpeechMicTraining',
    'DISPID_SWFESamplesPerSec', 'SPSMF_UPS', 'SPRULESTATE',
    'SpNotifyTranslator', 'SRCS_Disabled',
    'DISPID_SASCurrentDevicePosition', 'DISPID_SVVolume',
    'DISPID_SRRAlternates', 'SP_VISEME_13',
    'DISPID_SVSpeakCompleteEvent', 'DISPID_SpeechPhraseInfo',
    'SPEI_RESERVED2', 'SRTEmulated', 'DISPID_SVGetAudioInputs',
    'DISPID_SPRuleChildren', 'DISPID_SLPPartOfSpeech',
    'DISPID_SGRsCommit', 'SpPhoneticAlphabetConverter',
    'DISPID_SRState', 'SPEI_END_INPUT_STREAM', 'SDKLCurrentUser',
    'SpMMAudioIn', 'SGPronounciation', 'DISPID_SPAs_NewEnum',
    'SASClosed', 'DISPIDSPTSI_SelectionLength', 'DISPID_SVStatus',
    'DISPID_SPEAudioSizeTime', 'SPSLMA', 'DISPID_SPRText',
    'ISpRecognizer3', 'SPPS_Noun', 'SpeechTokenKeyFiles',
    'SPINTERFERENCE_TOOSLOW', 'SpeechRegistryUserRoot',
    'SPPS_RESERVED1', 'SVP_19', 'SPGS_ENABLED', 'SRCS_Enabled',
    'SPVPRIORITY', 'SAFT48kHz8BitStereo', 'SAFTCCITT_ALaw_22kHzMono',
    'SPPS_SuppressWord', 'DISPID_SPRsCount',
    'DISPID_SASCurrentSeekPosition', 'SSFMCreate',
    'DISPID_SGRSTWeight', 'DISPID_SOTDisplayUI',
    'SpeechDisplayAttributes', 'SREPropertyNumChange',
    'DISPID_SWFEAvgBytesPerSec', 'SPCS_DISABLED', 'DISPID_SLPsCount',
    'DISPID_SRCEHypothesis', 'SpCustomStream', 'SVSFNLPMask',
    'DISPID_SPEAudioTimeOffset', 'ISpNotifyTranslator',
    'SVSFIsNotXML', 'SP_VISEME_4', 'SPDKL_CurrentConfig',
    'DISPID_SGRsCommitAndSave', 'SpeechVoicePriority', 'SP_VISEME_9',
    'DISPID_SVSpeakStream', 'SPEI_RESERVED3', 'DISPID_SVSPhonemeId',
    'SAFTADPCM_44kHzStereo', 'SDA_Two_Trailing_Spaces',
    'ISpeechObjectTokens', 'DISPID_SRCEBookmark',
    'DISPID_SPARecoResult', 'DISPID_SOTDataKey',
    'DISPID_SRCCmdMaxAlternates', 'eLEXTYPE_PRIVATE6',
    'SPEI_VOICE_CHANGE', 'SSSPTRelativeToEnd', 'SP_VISEME_11',
    'ISpAudio', 'SREStreamStart', 'DISPID_SPRulesCount',
    'DISPID_SPIGetDisplayAttributes', 'SPWT_LEXICAL', 'SVSFDefault',
    'ISpXMLRecoResult', 'DISPID_SRCAudioInInterferenceStatus',
    'DISPID_SRCreateRecoContext', 'eLEXTYPE_APP',
    'DISPID_SRRecognizer', 'DISPID_SGRClear', 'DISPID_SRRRecoContext',
    'SAFTCCITT_ALaw_44kHzStereo', 'SPTEXTSELECTIONINFO',
    'DISPID_SRGCmdLoadFromMemory', 'SREInterference',
    'DISPID_SVSLastStreamNumberQueued',
    'DISPID_SRCRetainedAudioFormat', 'DISPID_SFSClose',
    'SAFTGSM610_11kHzMono', 'SGRSTTWord', 'SpeechRecognizerState',
    'SPEI_ADAPTATION', 'ISpeechAudioStatus', 'DISPID_SRRSaveToMemory',
    'SPRST_INACTIVE_WITH_PURGE', 'SPSEMANTICERRORINFO', 'SPEI_MAX_SR',
    'SLODynamic', 'DISPID_SABIBufferSize', 'SPSNotOverriden',
    'SPSMF_SRGS_SEMANTICINTERPRETATION_MS',
    'SpeechAudioFormatGUIDWave', 'SGRSTTRule', 'DISPID_SRCESoundEnd',
    'SVSFParseAutodetect', 'SPSHT_EMAIL', 'DISPID_SRGId', 'SASRun',
    'SPPHRASEPROPERTY', 'SPRECOSTATE', 'DISPID_SPRNumberOfElements',
    'DISPID_SBSRead', 'SECNormalConfidence', 'DISPID_SPPParent',
    'DISPID_SDKSetStringValue', 'SPINTERFERENCE_TOOFAST',
    'DISPID_SRRSpeakAudio', 'DISPID_SRAudioInput', 'DISPID_SPAsItem',
    'ISpPhoneticAlphabetSelection', 'SVSFParseSapi',
    'ISpeechLexiconPronunciation', 'DISPID_SRRGetXMLErrorInfo',
    'DISPID_SOTRemoveStorageFileName',
    'DISPID_SVSCurrentStreamNumber', 'SpeechTokenContext',
    'DISPID_SRCRetainedAudio', 'DISPID_SPRsItem',
    'SpeechGrammarState', 'SPSEMANTICFORMAT',
    'DISPID_SpeechObjectTokens', 'DISPID_SLGenerationId',
    'SAFT12kHz8BitStereo', 'SpeechRunState', 'ISpEventSource',
    'SVEViseme', 'SREStateChange', 'DISPID_SRCERecognizerStateChange',
    'DISPID_SPPNumberOfElements', 'SPAO_NONE',
    'DISPID_SRGSetWordSequenceData', 'SpInProcRecoContext',
    'DISPID_SPRuleConfidence', 'DISPID_SGRAttributes',
    'SpeechSpecialTransitionType', 'SPFM_OPEN_READWRITE',
    'DISPID_SPEDisplayText', 'SVPAlert', 'DISPID_SRCERequestUI',
    'SWPKnownWordPronounceable', 'SPRS_INACTIVE',
    'DISPID_SMSADeviceId', 'DISPID_SPIEnginePrivateData',
    'SVEAudioLevel', 'DISPID_SVEAudioLevel',
    ...
    'SPWP_UNKNOWN_WORD_UNPRONOUNCEABLE', 'IEnumString', 'SITooQuiet',
    'ISpRecoGrammar', 'DISPID_SRGState', 'ISpPhrase',
    'DISPID_SWFEBlockAlign',
    'DISPID_SpeechGrammarRuleStateTransitions', 'SPPS_RESERVED2',
    'SPADAPTATIONRELEVANCE', 'DISPID_SRStatus', 'SAFT44kHz8BitStereo',
    'SRAExport', 'DISPID_SOTCId', 'SPEI_TTS_AUDIO_LEVEL',
    'SPCATEGORYTYPE', 'DISPID_SpeechLexicon',
    'ISpeechPhraseReplacement', 'SpeechRecoProfileProperties',
    'SPWORDPRONUNCIATIONLIST', 'ISpPhoneticAlphabetConverter',
    'SDKLLocalMachine', 'DISPID_SOTsItem', 'DISPID_SVSVisemeId',
    'SPWF_SRENGINE', 'SGRSTTDictation', 'DISPID_SpeechVoiceEvent',
    'DISPID_SpeechGrammarRule', 'DISPID_SGRAddResource',
    'DISPID_SRCSetAdaptationData', 'DISPID_SOTGetDescription',
    'eLEXTYPE_PRIVATE15', 'SpeechPropertyAdaptationOn',
    'SpeechRecoEvents', 'SAFTGSM610_44kHzMono',
    'SAFTCCITT_uLaw_8kHzMono', 'ISpeechDataKey', 'ISpVoice',
    'SRERecognition', 'DISPID_SDKDeleteValue',
    'SpeechCategoryRecognizers', 'SAFTCCITT_ALaw_8kHzMono',
    'SPRS_ACTIVE_WITH_AUTO_PAUSE', 'ISpeechPhraseRule',
    'DISPID_SVESentenceBoundary', 'DISPID_SBSSeek',
    'eLEXTYPE_RESERVED7', 'SAFT44kHz16BitStereo', 'SPAUDIOSTATE',
    'SITooLoud', 'SPEVENT', 'SpeechPropertyResponseSpeed',
    'DISPID_SRGDictationLoad', 'SpeechStreamFileMode',
    ...
    'SAFTCCITT_uLaw_44kHzStereo', 'DISPID_SRGDictationSetState',
    'SVP_5', 'SLOStatic', 'DISPID_SRCCreateGrammar', 'SpStream',
    'DISPID_SGRAddState', 'SPPS_Unknown', 'DISPID_SRCEAudioLevel',
    'DISPID_SRGSetTextSelection', 'ISpeechTextSelectionInformation',
    'DISPID_SpeechObjectTokenCategory', 'eLEXTYPE_PRIVATE20',
    'SPWORDPRONOUNCEABLE', 'SAFTADPCM_11kHzMono',
    'DISPID_SRGDictationUnload', 'SINoise', 'LONG_PTR',
    ...
    'DISPID_SOTSetId', 'SPEI_MAX_TTS', 'ISpeechXMLRecoResult',
    'ISpeechPhraseInfoBuilder', 'SpWaveFormatEx', 'SPEI_MIN_TTS',
    'DISPID_SRSAudioStatus', 'SPRECORESULTTIMES',
    'DISPID_SPPs_NewEnum', 'DISPID_SRCEPropertyNumberChange',
    'SAFT44kHz16BitMono', 'ISpSerializeState',
    'SpeechEmulationCompareFlags', 'SPWAVEFORMATTYPE',
    'ISpeechPhraseElements', '_RemotableHandle', 'ISpeechVoiceStatus',
    'SVF_Emphasis', 'DISPID_SVSkip', 'SPSHORTCUTPAIRLIST',
    'SPRECOGNIZERSTATUS', 'ISpStream', 'SVP_20', 'SECFDefault',
    'SAFTADPCM_22kHzStereo', 'SVP_10', 'DISPID_SVAlertBoundary',
    'DISPID_SPEAudioSizeBytes', 'DISPID_SRGetFormat',
    'SPRST_INACTIVE', 'SPINTERFERENCE_NOISE',
    'ISpeechPhraseProperties', 'SRATopLevel', 'ISpEventSink',
    '__MIDL___MIDL_itf_sapi_0000_0020_0001', 'DISPID_SMSALineId',
    'DISPID_SADefaultFormat', 'DISPID_SVPriority', 'DISPID_SRProfile',
    'DISPID_SLRemovePronunciation', 'DISPID_SGRSTransitions',
    'SAFT22kHz8BitStereo', 'DISPID_SpeechAudioStatus', 'SVP_2',
    'SVEWordBoundary', 'SPSSuppressWord', 'DISPID_SRRAudio',
    'SpeechDictationTopicSpelling', 'SPPS_Function', 'SVPOver',
    'ISpLexicon', 'SPAO_RETAIN_AUDIO', 'SRERecoOtherContext',
    'DISPID_SRCEventInterests', 'ISpeechCustomStream',
    'DISPID_SRRTimes', 'DISPID_SpeechVoiceStatus',
    'DISPID_SRCRecognizer', 'SPWP_UNKNOWN_WORD_PRONOUNCEABLE',
    'DISPID_SVAudioOutputStream', 'SP_VISEME_12',
    'DISPID_SpeechLexiconPronunciation', 'SPSERIALIZEDPHRASE',
    'DISPID_SRCEPropertyStringChange', 'SVP_12', 'SBONone',
    'SAFTGSM610_22kHzMono', 'ISpeechGrammarRules',
    'DISPID_SGRsFindRule', 'SPSERIALIZEDRESULT', 'SPEI_UNDEFINED',
    'SVPNormal', 'SDTProperty', 'SPEI_VISEME', 'SGSExclusive',
    'SpeechFormatType', 'SpeechAllElements', 'SPAR_Medium',
    'SPBINARYGRAMMAR', 'DISPID_SDKOpenKey', 'DISPID_SPIAudioSizeTime',
    '__MIDL_IWinTypes_0009', 'SPFM_NUM_MODES', 'SRSEIsSpeaking',
    'UINT_PTR', 'DISPID_SPIGrammarId', 'DISPID_SVRate',
    'DISPID_SOTIsUISupported', 'SPPS_Modifier', 'eLEXTYPE_MORPHOLOGY',
    'SAFTTrueSpeech_8kHz1BitMono', 'SpeechAudioState',
    'SPVPRI_NORMAL', 'eLEXTYPE_RESERVED8', 'SVP_1',
    'SREPropertyStringChange', 'SpCompressedLexicon',
    'DISPID_SPIProperties', 'ISequentialStream', 'SPINTERFERENCE',
    'SP_VISEME_20', 'ISpShortcut', 'ISpRecoGrammar2',
    'SpeechPropertyComplexResponseSpeed', 'SDTAudio',
    'SpeechDiscardType', 'SPPS_NotOverriden', 'SRESoundStart',
    'ISpeechRecoResult', 'eLEXTYPE_PRIVATE2', 'SpObjectToken',
    ...
    'SECFNoSpecialChars', 'SPLO_STATIC', 'SECFEmulateResult',
    '_ISpeechVoiceEvents', 'SpeechCategoryAppLexicons',
    'DISPID_SRCCreateResultFromMemory', 'ISpMMSysAudio',
    'SpSharedRecognizer', 'STSF_LocalAppData', 'SPVISEMES',
    'SRSActiveAlways', 'DISPID_SPEPronunciation',
    'DISPID_SRCEInterference', 'DISPID_SRCResume',
    'SPEI_END_SR_STREAM', 'DISPID_SVSyncronousSpeakTimeout',
    'DISPID_SRGCmdLoadFromObject', 'DISPID_SpeechLexiconWord',
    'SP_VISEME_10', 'SFTSREngine', 'ISpeechGrammarRule',
    'DISPID_SRGRecoContext', 'DISPID_SRSCurrentStreamNumber',
    'ISpeechLexiconWord', 'SPEI_REQUEST_UI', 'SPSHT_Unknown',
    'SPAR_Low', 'DISPID_SPEEngineConfidence', 'DISPID_SRDisplayUI',
    ...
    'SDKLDefaultLocation', 'ISpRecognizer', 'DISPID_SRIsShared',
    'DISPID_SpeechFileStream', 'SRSInactive', 'SP_VISEME_3',
    'SVSFPersistXML', 'SPEI_MIN_SR', 'SAFTADPCM_11kHzStereo',
    'SP_VISEME_1', 'DISPID_SRGCommit', 'SPEI_SENTENCE_BOUNDARY',
    'SpMMAudioEnum', 'DISPID_SPRules_NewEnum',
    'ISpeechPhraseAlternate', 'eLEXTYPE_VENDORLEXICON',
    'DISPID_SASState', 'DISPID_SpeechGrammarRules', 'SRTReSent',
    'DISPID_SRCEEndStream', 'DISPID_SVSInputSentenceLength',
    'SREHypothesis', 'DISPID_SpeechRecognizer',
    'DISPID_SRIsUISupported', 'DISPID_SRSetPropertyNumber',
    'DISPID_SLPLangId', 'DISPID_SOTRemove', 'SVSFUnusedFlags',
    'SRERequestUI', 'SPSHT_OTHER', 'SDTRule', 'SVSFlagsAsync',
    'DISPID_SRRAudioFormat', 'DISPID_SLGetPronunciations',
    'ISpeechLexicon', 'SpVoice', 'DISPID_SRCState',
    'SWPUnknownWordPronounceable', 'SWPUnknownWordUnpronounceable',
    'eWORDTYPE_ADDED', 'SREPrivate', 'ISpeechFileStream',
    'SAFT8kHz16BitMono', 'SpeechTokenKeyAttributes',
    'DISPID_SLGetGenerationChange', 'DISPID_SMSSetData',
    'STCLocalServer', 'DISPID_SRCVoice',
    'DISPID_SPANumberOfElementsInResult', 'SPEI_START_INPUT_STREAM',
    'DISPID_SpeechLexiconWords', 'SRSInactiveWithPurge', 'SPWORDLIST',
    'DISPID_SRSSupportedLanguages', 'ISpeechPhraseElement',
    'SVEPrivate', 'SpShortcut', 'DISPID_SOTCEnumerateTokens',
    'DISPID_SGRSTPropertyName', 'SpeechInterference',
    'DISPID_SPRFirstElement', 'SPEI_START_SR_STREAM',
    'Speech_StreamPos_Asap', 'SPEI_WORD_BOUNDARY',
    'SDA_One_Trailing_Space', 'DISPID_SDKSetLongValue',
    'tagSPTEXTSELECTIONINFO', 'SFTInput', 'eLEXTYPE_PRIVATE17',
    'ISpeechRecoResultDispatch', 'eLEXTYPE_PRIVATE1',
    'SAFTCCITT_uLaw_44kHzMono', 'SpeechRegistryLocalMachineRoot',
    'DISPID_SGRsItem', 'DISPID_SPPConfidence', 'SSSPTRelativeToStart',
    'SpeechRuleState', 'DISPID_SPCPhoneToId', 'SPAUDIOBUFFERINFO',
    'SREBookmark', 'SPAUDIOOPTIONS', 'SVEVoiceChange',
    'SPDKL_DefaultLocation', 'SpeechTokenKeyUI', 'eLEXTYPE_PRIVATE11',
    'SGSDisabled', 'DISPID_SpeechLexiconProns', 'SPRST_ACTIVE_ALWAYS',
    'DISPID_SRGCmdSetRuleState', 'SRAONone', 'SSFMCreateForWrite',
    'SPPARTOFSPEECH', 'SASStop', 'SVP_9', 'DISPID_SOTCDefault',
    'SAFT22kHz16BitMono', 'DISPID_SGRSTPropertyValue',
    'IEnumSpObjectTokens', 'DISPID_SOTMatchesAttributes',
    'SPDKL_LocalMachine', 'DISPID_SRCBookmark',
    'DISPID_SRGCmdLoadFromProprietaryGrammar',
    'SpStreamFormatConverter', 'DISPID_SVSInputWordLength',
    'DISPID_SpeechVoice', 'DISPID_SMSAMMHandle', 'SPDATAKEYLOCATION',
    'DISPID_SVEViseme', 'DISPID_SpeechRecognizerStatus',
    'SP_VISEME_0', 'SpResourceManager', 'SPEI_RECO_STATE_CHANGE',
    'DISPID_SDKGetlongValue', 'SPCT_SLEEP', 'SpeechRecoContextState',
    'SGDisplay', 'SPRS_ACTIVE_USER_DELIMITED',
    'SPWT_LEXICAL_NO_SPECIAL_CHARS', 'SPWT_DISPLAY',
    'DISPID_SRCVoicePurgeEvent', 'ISpNotifySink', 'SPBO_AHEAD',
    'eWORDTYPE_DELETED', 'SPWT_PRONUNCIATION', 'DISPID_SPACommit',
    'SGRSTTEpsilon', 'DISPID_SPPValue'
]

_check_version('1.2.0', 1700106500.566297)
